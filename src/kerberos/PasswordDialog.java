 ...
 * ein Passwort über diesen Dialog erfragt. Ansonsten hat diese Klasse keinen weiteren Nutzen.
 */
import java.awt.*;
...
public class PasswordDialog extends JDialog {
	...
	public PasswordDialog(String userName) {
		...
		// Text-Anzeige
		JLabel labelMessage1 = new JLabel("<html><body><font size=\"+1\">" + "<em>Bitte Passwort f�r " + userName
